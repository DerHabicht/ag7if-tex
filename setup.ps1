...
New-Item -Path "${TEXMFHOME}\tex\contbook.cls" -ItemType SymbolicLink -Value .\cls\contbook.cls 
New-Item -Path "${TEXMFHOME}\tex\fileplan.cls" -ItemType SymbolicLink -Value .\cls\fileplan.cls 
